Attribute VB_Name = "Ref_BOM_Manual"
Sub createSheetManual()
Attribute createSheetManual.VB_Description = "Macro developed 15/11/202 by Alison Osnir"
Attribute createSheetManual.VB_ProcData.VB_Invoke_Func = " \n14"
'
' createSheetManual Macro
...
'
    ...
    'FORMAT CSV SHEET
        ...
        'MANUAL ADJUSTMENT OF THE CSV COLUMNS
        ...
        Range("A1").FormulaR1C1 = "AJUSTE AS COLUNAS PARA A SEGUINTE ORDEM:"
        Range("A2").FormulaR1C1 = "Position"
        Range("B2").FormulaR1C1 = "Coord. X"
        Range("C2").FormulaR1C1 = "Coord. Y"
    ...
    'ADD VLOOKUP TO MAIN SHEET
        ...
        ExcelSheet2.Cells(1, 4).Formula = "=VLookup($A1, CSV!$A:$AA, 2, False)"
        ExcelSheet2.Cells(1, 5).Formula = "=VLookup($A1, CSV!$A:$AA, 3, False)"
        ExcelSheet2.Cells(1, 6).Formula = "=VLookup($A1, CSV!$A:$AA, 4, False)"
        ExcelSheet2.Cells(1, 7).Formula = "=VLookup($A1, CSV!$A:$AA, 5, False)"
